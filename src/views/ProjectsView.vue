...
<section class="p-5 m-5 position-relative">
    <div class="container">
        <ProjectSingle v-for="(p, i) in projects" :key="i" :title="p['title']" :link="p['link']" :img="p['img']" :desc="p['desc']" :img_desc="p['img_desc']" />
    </div>
</section>
</template>
    ...
    data() {
        return {
            projects: [{
                    ...
                    img_desc: 'Automated text evaluation for tutors and learners'
                },
                {
                    ...
                    img_desc: 'Use of robots in an interconnected digital society'
                },
                {
                    ...
                    img_desc: 'Semantic search and analysis in the Romanian literary heritage'
                },
                {
                    ...
                    img_desc: 'Elderly people can prepare themselves for conversations with healthcare professionals'
                },
                {
                    ...
                    img_desc: 'Relevant documents are provided based on keywords and through analyses of other documents'
                },
                {
                    title: 'EARLY NUTRITION EACADEMY SOUTHEAST ASIA (ENEA SEA)',
                    link: '/projects/enea-sea',
                    ...
                    img_desc: 'Innovative e-learning for practicing doctors in the field of early nutrition in Southeast Asia'
                },
                {
                    ...
                    img_desc: 'Relevant textual resources to be consulted (scientific papers, doctoral theses, patents, etc.) to facilitate the process of writing research topics'
                },
                {
                    ...
                    img_desc: 'Delivering access to advanced gaming technology resources and state-of-the-art knowledge to develop Applied Games easier, faster and more cost-effectively'
                },
                {
                    ...
                    img_desc: 'Finding new innovative ways to tackle this newest challenge is one of the ambitions of the Language Technologies for Lifelong Learning project (LTfLL). Its two baseline objectives are: (a) helping people learn, and, (b) helping tutors/teachers to support learners.'
                }
            ]
        }
    }

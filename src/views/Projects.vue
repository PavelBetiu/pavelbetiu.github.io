        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-8 text-center mx-auto my-auto">
              <h1 class="text-white">Some short description of the team</h1>
              <p class="lead mb-4 text-white opacity-8">Some longer description of our team</p>
              <h6 class="text-white mb-2 mt-5">Find us on</h6>
              <div class="d-flex justify-content-center">
                <a href="javascript:;"><font-awesome-icon icon="fa-brands fa-facebook" class="text-lg text-white" /></a>
                &nbsp;&nbsp;
                <a href="javascript:;"><font-awesome-icon icon="fa-brands fa-instagram" class="text-lg text-white" /></a>
                &nbsp;&nbsp;
                <a href="javascript:;"><font-awesome-icon icon="fa-brands fa-twitter" class="text-lg text-white" /></a>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 text-start mb-5 mt-5">
            <h3 class="text-white z-index-1 position-relative">Our Projects</h3>
            <p class="text-white opacity-8 mb-0">Some intro for our projects (TODO).</p>
          </div>
        </div>
        <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12 pe-lg-0">
                  <a href="javascript:;">
                    <div class="p-3 pe-md-0">
                      <img class="w-100 border-radius-md" src="../assets/images/ates.jpeg" alt="image">
                    </div>
                  </a>
                </div>
                <div class="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
                  <div class="card-body">
                    <h5 class="mb-0">Automated Text Evaluation and Simplification</h5>
                    <h6 class="text-info">Physical Sciences and Engineering</h6>
                    <p class="mb-0">The project wants to enable writers to improve the quality of their writing, in both English and Romanian languages, with immediate feedback when typing the input text through personalized recommendations and highlights of different text elements that can be improved.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card card-profile mt-lg-0 mt-5 overflow-hidden">
              <div class="row">
                <div class="col-lg-4 col-md-6 col-12 pe-lg-0">
                  <a href="javascript:;">
                    <div class="p-3 pe-md-0">
                      <img class="w-100 border-radius-md" src="../assets/images/robin.jpeg" alt="image">
                    </div>
                  </a>
                </div>
                <div class="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
                  <div class="card-body">
                    <h5 class="mb-0">Robots and Society: Cognitive Systems for Personal Robots and Autonomous Vehicles (Robin)</h5>
                    <h6 class="text-info">Information and Communication Technologies</h6>
                    <p>User-centered project designing software and services modules for the use of robots in an interconnected digital society that enables companies to develop complex, intelligent and performing products and services for these users as well as society as a whole.</p>
                  </div>
                </div>
              </div>
            </div>

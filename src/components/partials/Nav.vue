        ...
        data() {
            return {
                items: [{
                        ...
                        command: (event) => { this.$router.push('/profile') }
                    },
                    {
                        label: 'Datasets',
                        icon: 'pi pi-fw pi-database',
                        command: (event) => { this.$router.push('/datasets') }
                    },
                    {
                        label: 'Models',
                        icon: 'pi pi-fw pi-chart-bar',
                        command: (event) => { this.$router.push('/models') }
                    },
                    {
                        label: 'Processing Queue',
                        icon: 'pi pi-fw pi-list',
                        command: (event) => { this.$router.push('/processing-queue') }
                    },
                    {
                        separator: true
                    },

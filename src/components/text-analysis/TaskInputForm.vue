<template>
    ...
    <div id="textAnalysisForm" class="card m-5">
        <div class="card-header text-center pt-4 pb-3 d-flex justify-content-center">
            <span class="badge rounded-pill bg-light text-dark">Sentiment Analysis</span>
        </div>
        <div class="card-body text-lg-left text-center px-5 pb-2">
            ...
            <div v-if="doneProcessing" id="textLabelResponse"><p class="badge bg-gradient-success">{{textLabelResponse}}</p></div>
    ...
    methods: {
        ...
        process() {
            ...
            setTimeout(() => {
                ...
                this.textLabelResponse = 'Happiness'
            }, 3000);
        },
    },
};
